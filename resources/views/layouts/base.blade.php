        ...
        <div class="flex items-center md:order-2 space-x-1 md:space-x-0 rtl:space-x-reverse relative" x-data="{ open: false }">
            ...
            <div x-show="open" @click.outside="open = false" class="absolute right-0 top-12 w-48 bg-white rounded-lg shadow-lg z-10">
                ...
                <ul class="py-2 font-medium" role="none">
                    <li class="h-12">
                        <a href="{{ url('profile') }}" class="flex items-center justify-center block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white">
                    ...
                    <li class="h-12">
                        <form method="POST" action="{{ route('logout') }}" class="w-full h-12">
                            ...
                            <button type="submit" class="flex items-center justify-center w-full h-12 block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white">
                                <div class="inline-flex items-center">
