  ...
  <section class="bg-white dark:bg-gray-900">
    <div class="lg:grid lg:min-h-screen lg:grid-cols-12">
      <aside class="relative block h-16 lg:order-last lg:col-span-5 lg:h-full xl:col-span-6">
        <img
          alt=""
          src="{{ asset('assets/images/pokemon-trainer.jpg') }}"
      ...
      <main
        ...
        <div class="max-w-xl lg:max-w-3xl">
          <a class="block text-blue-600" href="#">
            <img src="{{ asset('assets/images/trainers.png') }}" alt="pokebola">
          </a>

          <h1 class="mt-6 text-2xl font-bold text-gray-900 sm:text-3xl md:text-4xl dark:text-white">
            Create and store your Trainer! 🧑
          </h1>

          <p class="mt-4 leading-relaxed text-gray-500">
            Create your Trainer, give him a name and gotta catch'em all!
          </p>


          <form action="{{ url('trainers') }}" method="POST" class="mt-8 grid grid-cols-6 gap-6" enctype="multipart/form-data" >
            @csrf
            ...
            <div class="col-span-6 sm:col-span-2">
              <button
                class="inline-block w-full shrink-0 rounded-md border border-red-500 px-12 py-3 text-sm font-medium text-red-500 transition hover:bg-transparent hover:text-white focus:outline-none active:text-red-600 dark:hover:bg-red-700 dark:hover:text-white">
                Create Trainer
              </button>
