...
<a href="{{ url('/pokemon') }}" class="flex items-center hover:opacity-65 transition-all">
    ...
    <span class="font-semibold text-xl tracking-tight ml-5">Edit Pokémon</span>
</a>
@endsection
    ...
    <div class="w-2/3 flex justify-center items-center">
        <div>
            ...
            <h1 class="mt-6 text-2xl font-bold text-gray-900 sm:text-3xl md:text-4xl">
                Edit and update your Pokémon 👹
            </h1>

            <p class="mt-4 leading-relaxed text-gray-500">
                Oops! Here you can edit and update your Pokémon in case you made something wrong!
            </p>
