...
@section('title', 'Seus treinadores')
@section('title_nav')
<a href="{{ url('/') }}" class="flex items-center hover:opacity-65 transition-all">
    ...
    <span class="font-semibold text-xl tracking-tight ml-5">Treinadores</span>
</a>
@endsection
        ...
        <div class="flex flex-col justify-between p-4 leading-normal w-2/3">
            ...
            <div class="absolute bottom-4 right-5">
                <span class="inline-flex mt-2 -space-x-px overflow-hidden rounded-md border border-gray-900 shadow-sm">
                    <a href="{{ url('coaches/'.$entity->id.'/edit') }}" class="transition-all inline-block px-4 py-2 text-sm font-medium text-gray-900 hover:bg-gray-600 hover:text-white focus:relative">Editar</a>
...
@else
<h1 class="w-full p-10 text-2xl font-bold text-center">Você precisa estar logado para visualizar os Treinadores.</h1>
@endcan
